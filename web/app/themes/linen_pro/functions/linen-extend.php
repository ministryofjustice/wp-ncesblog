...
if (!class_exists( 'Linen' )) {
	class Linen extends TTFCore {
		...
		public function filter_front_page_posts( $query ) {
			...
			$apply_filter =
				$this->use_featured_header() &&
				( is_front_page() || $wp_query->is_posts_page );
			...
			*/
			...
			$this->options = array(
				...
				array(
					...
					"desc" => __( 'Turn on your featured slider. The featured slider requires a minimum of 2 sticky posts.', 'linen' ),
					"std" => "false",
					"type" => "checkbox"),
